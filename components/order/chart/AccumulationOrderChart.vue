  ...
  <v-layout row wrap style="width: 100%">
    <v-flex xs12 class="pa-2 mt-2">
      <div style="width: 100%; height: auto">
        <div
          id="AccumulationOrderChart"
          style="width: 100%; height: 600px"
          ref="AccumulationOrderChart"
        ></div>
      </div>
    </v-flex>
  </v-layout>
...
export default {
  ...
  methods: {
    ...
    renderData() {
      ...
      if (this.chart == null) {
        this.chart = new CanvasJS.Chart("AccumulationOrderChart", {
        ...
        this.chart.options.subtitles[0].text = this.$t("accumulationOrder");
