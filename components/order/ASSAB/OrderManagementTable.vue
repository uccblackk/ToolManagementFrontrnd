          ...
          <v-form ref="editForm" v-model="valid" lazy-validation>
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="3" md="3" v-if="hasCustomerOrder == 'Y'">
                  <v-text-field
                    ref="customerName"
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('ASSABName')"
                    v-model="editMoForm.parameter.ASSABName"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('resourceThickness')"
                    v-model="editMoForm.parameter.resourceThickness"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('resourceWidth')"
                    v-model="editMoForm.parameter.resourceWidth"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('resourceLength')"
                    v-model="editMoForm.parameter.resourceLength"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    ...
                    v-model="editMoForm.parameter.customThickness"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('customWidth')"
                    v-model="editMoForm.parameter.customWidth"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('customLength')"
                    v-model="editMoForm.parameter.customLength"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3"> </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('widthUpperTolerance')"
                    v-model="editMoForm.parameter.widthUpperTolerance"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('thicknessUpperTolerance')"
                    v-model="editMoForm.parameter.thicknessUpperTolerance"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('lengthUpperTolerance')"
                    v-model="editMoForm.parameter.lengthUpperTolerance"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3"> </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('widthLowerTolerance')"
                    v-model="editMoForm.parameter.widthLowerTolerance"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('thicknessLowerTolerance')"
                    v-model="editMoForm.parameter.thicknessLowerTolerance"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('lengthLowerTolerance')"
                    v-model="editMoForm.parameter.lengthLowerTolerance"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('MACHP')"
                    v-model="editMoForm.parameter.MACHP"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('zHeat')"
                    v-model="editMoForm.parameter.zHeat"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('chamfering')"
                    v-model="editMoForm.parameter.chamfering"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    ...
                    v-model="editMoForm.parameter.classification"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    ...
                    v-model="editMoForm.parameter.materialName"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('flatness')"
                    v-model="editMoForm.parameter.flatness"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('salesDoc')"
                    v-model="editMoForm.parameter.salesDoc"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('itemCount')"
                    v-model="editMoForm.parameter.itemCount"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('transpZone')"
                    v-model="editMoForm.parameter.transpZone"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('customerMaterialNum')"
                    v-model="editMoForm.parameter.customerMaterialNum"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('bottomChamfering')"
                    v-model="editMoForm.parameter.bottomChamfering"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('aroundChamfering')"
                    v-model="editMoForm.parameter.aroundChamfering"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('topChamfering')"
                    v-model="editMoForm.parameter.topChamfering"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field
                    :label="$t('weight')"
                    v-model="editMoForm.parameter.weight"
                    required
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="3" md="3">
  ...
  methods: {
    ...
    showMoEditDialog(item) {
      ...
      if (item.parameter != null) {
        this.editMoForm.parameter = item.parameter;
      }
    ...
    editMo() {
      ...
      const mo = {
        ...
        parameter: this.editMoForm.parameter,
  ...
  computed: {
    ...
    moheaders() {
      ...
      headers = [
        ...
        {
          text: this.$t("itemCount"),
          value: "parameter.itemCount",
          sortable: false,
          align: "left",
          width: "150px"
        },
        ...
        },
        {
          ...
          value: "parameter.resourceThickness",
          sortable: true,
          align: "center",
        ...
        },
        {
          ...
          value: "parameter.resourceLength",
          sortable: true,
          align: "center",
