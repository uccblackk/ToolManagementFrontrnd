<template>
  <div style="width: 100%; height: auto">
    <div
      id="workEfficiencyChart"
      style="width:100%; height: 50vh"
      ref="workEfficiencyChart"
    ></div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    renderData() {
      ...
      let chart = null;
      // if (this.width != null) {
      //   chart = new CanvasJS.Chart("workEfficiencyChart", {
      ...
      // } else {
      if (this.chart == null) {
        this.chart = new CanvasJS.Chart("workEfficiencyChart", {
          animationEnabled: true,
          animationDuration: 50,
          exportEnabled: true,
          dataPointMaxWidth: 50,
        ...
        this.chart.options.data[0].dataPoints = this.percentData;
      }
      //   }
  ...
  mounted() {
    ...
    //   width,
    //   height
    // } = this.$refs.workEfficiencyChart.getBoundingClientRect();
    // this.width = width;
    // this.height = height;
  },
