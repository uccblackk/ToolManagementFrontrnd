...
background: linear-gradient(45deg, rgba(35,36,79,1) 0%, rgba(57,116,146,1) 100%);"
    ...
    >
      ...
      >
        {{ "Y4自動化產線" }}
        <span class="ml-2 text-overline">{{ "(9臺設備)" }}</span>
        <v-spacer />
        <span class="caption">
          {{ date }}
        </span>
          ...
          <v-col cols="3">
            <div style="height:350px;margin-top:20px" class=" align-center">
              <v-row no-gutters justify="center">
                ...
                <v-col cols="7">
                  <div id="OEEPieChart1" style="height:350px"></div>
                </v-col>
            ...
            <v-row justify="center" style="margin-top:10px">
              <v-col cols="2">
                <v-row>
                  <v-col cols="12">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'DR002')"
                      height="40px"
                      :trayData="trayData"
                    />
                  </v-col>
                  <v-col cols="12">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'NXV600A-2')"
                      height="70px"
                      :trayData="trayData"
                    />
                  </v-col>
              ...
              <v-col cols="6" align-self="center">
                <v-row>
                  <v-col cols="4">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'NH500A-5')"
                      height="200px"
                      :trayData="trayData"
                    />
                  </v-col>
                  ...
                  <v-col cols="4">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'NH500A-6')"
                      height="200px"
                      :trayData="trayData"
                    />
                  </v-col>
                  <v-col cols="4">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'NH500A-7')"
                      height="200px"
                      :trayData="trayData"
                    />
                  </v-col>
              ...
              <v-col cols="3">
                <v-row>
                  <v-col cols="6">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'RT001')"
                      height="40px"
                      :trayData="trayData"
                    />
                  </v-col>
                  <v-col cols="6">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'SL001')"
                      height="40px"
                      :trayData="trayData"
                    />
                  </v-col>
                  <v-col cols="6">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'BR001')"
                      height="40px"
                      :trayData="trayData"
                    />
                  </v-col>
                  <v-col cols="6">
                    <MachineStatusCard
                      :machineData="machineList.find(x => x.no == 'RT002')"
                      height="40px"
                      :trayData="trayData"
                    />
                  </v-col>
...
export default {
  ...
  methods: {
    ...
    renderData(dataPoints) {
      ...
      if (this.chart == null) {
        this.chart = new CanvasJS.Chart("OEEPieChart1", {
    ...
    async getOEEData() {
      ...
      this.$axios
        .$get(
          `/OEE/GetTotalMachineOEE?startTime=${dates[0]}&endTime=${dates[0]}&lineNo=L02`,
          {
            headers: {
              Authorization: token
            }
