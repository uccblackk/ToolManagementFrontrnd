      ...
      >
        <template v-slot:top>
          <div style="text-align:right">
            <v-btn color="primary" dark class="mb-2" @click="createSheet()">
              <excel-export
                filename="report"
                :sheet="sheet"
                :manual="true"
        ...
        <template v-slot:item.scheduleEndDate="{ item }">
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          text: this.$t("actual") + this.$t("end") + this.$t("time"),
          value: "actualEndDate",
          align: "start",
          sortable: true,
          width: "150px"
    ...
    createSheet() {
      ...
      this.lotWipList.forEach(lotWip => {
        lotWip.lotWipLog.forEach(log => {
          ...
          if (log.wipDesc != null && log.wipDesc != "") {
            wipdesc = log.wipDesc;
          }
          let item = {
            ...
            planEndDate: lotWip.moData.planEndDate,
            planQty: lotWip.lotOpData.dispatchQty,
            completedQty: lotWip.lotOpData.completedQty,
            moCreateDateTime: new Date(
              lotWip.moData.createTime
            ).toLocaleString(),
            logDate: new Date(log.logDate).toLocaleString(),
      ...
      this.sheet = [
        {
          ...
          tHeader: [
            ...
            this.$t("product") + this.$t("No"),
            this.$t("product") + this.$t("name"),
            this.$t("type"),
            this.$t("equipment") + this.$t("name"),
            this.$t("process") + this.$t("No"),
            this.$t("process") + this.$t("name"),
            this.$t("status"),
            this.$t("dispatch") + this.$t("start") + this.$t("time"),
            this.$t("dispatch") + this.$t("end") + this.$t("time"),
            this.$t("require") + this.$t("count"),
