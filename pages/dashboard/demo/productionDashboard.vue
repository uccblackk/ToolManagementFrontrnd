...
<script>
import UtilizationPieChart from "~/components/dashboard/demo/UtilizationPieChart.vue";
import LotProgress from "~/components/dashboard/demo/LotProgress.vue";
import OEEChart from "~/components/dashboard/demo/OEEChart.vue";
import OEETrend from "~/components/dashboard/demo/OEETrend.vue";
import ProduceCount from "~/components/dashboard/demo/ProduceCount.vue";
import UtilizationTrend from "~/components/dashboard/demo/UtilizationTrend.vue";
import MachineStatus from "~/components/dashboard/demo/MachineStatus.vue";
