...
export default {
    ...
    onSearch(data) {
      ...
      this.$axios
        ...
        .then(res => {
          ...
          //     data.push(
          //       array.filter(
          //         x => x.lotWipData.resourceNo == this.machineData[j].no
          //       )
          //     );
          //   }
          ...
          //     data.push(
          //       array.filter(
          //         x => x.lotWipData.resourceNo == this.lineData[j].lineNo
          //       )
          //     );
          //   }
          ...
          //   for (let i = 0; i < data.length; i++) {
          //     data[i].forEach(element => {
          //       if (!this.lotWipData.includes(element)) {
          //         this.lotWipData.push(element);
          //       }
          //     });
          //   }
  ...
  mounted() {
    this.jobReportTag = setting.jobReport;
    this.refreshMachineData();
