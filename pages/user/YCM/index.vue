          ...
          <v-card-text>
            <v-container>
              <v-row>
                ...
                <v-col cols="6">
                  <v-text-field
                    :label="$t('organizeGroupDepartment')"
                    v-model="addUserForm.organizeGroupDepartment"
            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="6">
                  <v-text-field
                    :label="$t('organizeGroupDepartment')"
                    v-model="editUserForm.organizeGroupDepartment"
                    prepend-icon="mdi-account-group"
                  ></v-text-field>
                </v-col>
                <!-- 軍種 -->
...
export default {
  ...
  methods: {
    ...
    addUser() {
      ...
      // 加入客製參數
      let setting = {};
      //永進&中科院_客製參數(服務單位,編製單位,軍種,官階)

      setting = {
        department: this.addUserForm.department,
        organizeGroupDepartment: this.addUserForm.organizeGroupDepartment,
        force: this.addUserForm.force,
        rank: this.addUserForm.rank
      };
    ...
    editUser() {
      ...
      setting = {
        ...
        organizeGroupDepartment: this.editUserForm.organizeGroupDepartment,
        force: this.editUserForm.force,
        rank: this.editUserForm.rank
      };
      ...
      this.$axios
        ...
        .then(res => {
          ...
          this.editUserForm.department = null;
          this.editUserForm.organizeGroupDepartment = null;
          this.editUserForm.force = null;
          this.editUserForm.rank = null;
        })
        .then(() => {});
    },
    showEditUserDialog(item) {
      ...
      this.editUserForm.department = item.setting.department;
      this.editUserForm.organizeGroupDepartment =
        item.setting.organizeGroupDepartment;
      this.editUserForm.force = item.setting.force;
      this.editUserForm.rank = item.setting.rank;
    },
