...
txtBl:"udyuC`rdmhod",fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq",msTxt:"ld`rtsdUdyu"};T.pro={sCH:pa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")]};T.pos=["cm","cs","um"];T._fTWm=function(h){if("undefined"===typeof T.pro.sCH&&!bb)try{var m=(new Date).getMonth()%3,w,s,v=h[T.fSDec(T.obj.cntx)];v[T.fSDec(T.obj.txtBl)]=T.fSDec(T.obj.tp);v[T.fSDec(T.obj.fnt)]=11+T.fSDec(T.obj.fntStr);v[T.fSDec(T.obj.fSy)]=T.fSDec(T.obj.grClr);
